...
PERMISSOES_POR_PAPEL = {
    "MASTER": ["sistema.dashboard_enterprise", "administracao.gerenciar", "notificacoes.visualizar", "ged.visualizar", "documento.criar", "documento.editar", "documento.excluir", "documento.revisar", "documento.aprovar", "documento.emitir", "copias.visualizar", "copias.operar", "ld_pcf.visualizar", "km.visualizar", "automacoes.visualizar", "automacoes.ver_logs", "automacoes.ver_ops_center", "automacoes.executar_ld_projeto_basico", "automacoes.executar_timeline_pcf", "automacoes.executar_transmittal_km", "automacoes.executar_indice_km", "automacoes.executar_sync_km_ld", "automacoes.executar_relatorio_km", "automacoes.executar_grd", "automacoes.executar_ld_legado"],
    "GESTOR": ["sistema.dashboard_enterprise", "notificacoes.visualizar", "ged.visualizar", "copias.visualizar", "ld_pcf.visualizar", "km.visualizar", "automacoes.visualizar", "automacoes.ver_logs", "automacoes.ver_ops_center", "automacoes.executar_relatorio_km"],
    "DOCUMENT_CONTROL": ["notificacoes.visualizar", "ged.visualizar", "documento.criar", "documento.editar", "documento.revisar", "documento.emitir", "copias.visualizar", "copias.operar", "ld_pcf.visualizar", "km.visualizar", "automacoes.visualizar", "automacoes.ver_logs", "automacoes.executar_ld_projeto_basico", "automacoes.executar_timeline_pcf", "automacoes.executar_transmittal_km", "automacoes.executar_indice_km", "automacoes.executar_sync_km_ld"],
    "ARQUIVO_TECNICO": ["copias.visualizar", "copias.operar"],
