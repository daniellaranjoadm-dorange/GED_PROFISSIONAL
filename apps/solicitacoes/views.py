...
from backend.apps.apps.solicitacoes.forms import SolicitarAcessoForm
from backend.apps.apps.solicitacoes.models import SolicitarAcesso
from backend.apps.apps.solicitacoes.services import (
...
def detalhe_solicitacao(request, id):
    ...
    if request.method == "POST":
        ...
        if acao == "aprovar":
            # 1) Cria / vincula o usuário e atribui Role + Group
            ...
            # 4) Notifica solicitante (com senha, se usuário foi criado agora)
            notificar_decisao_solicitacao(
                solicitacao,
            ...
            # Notifica solicitante sobre recusa
            notificar_decisao_solicitacao(
                solicitacao,
                senha_temporaria=None,
            )
